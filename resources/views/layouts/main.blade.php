                    ...
                    <ul id="sidebarnav">
                        <li class="sidebar-item">
                            <a  class="sidebar-link {{ request()->routeIs('users.dashboard') ? 'active' : '' }}" href="{{ Route::has('users.dashboard') ? route('users.dashboard') : url('users.dashboard') }}">
                                <i class="mdi mdi-adjust"></i><span class="hide-menu"> Dashboard</span>
                                                     ...
                                                     <li class="sidebar-item"><a  class="sidebar-link {{ request()->routeIs('project-proposals.index') ? 'active' : '' }}" href="{{ Route::has('cmp-managers.index') ? route('cmp-managers.index') : url('/cmp-managers/index') }}"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Sub Category</span></a></li>
                        </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-spin fa-cog"></i><span class="hide-menu">Directives</span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a  class="sidebar-link {{ request()->routeIs('users.dashboard') ? '' : '' }}" href="{{ Route::has('users.dashboard') ? route('users.dashboard') : url('users.dashboard') }}"><i class="mdi mdi-adjust"></i><span class="hide-menu"> 1. DashBoard</span></a></li>
                                <li class="sidebar-item"><a  class="sidebar-link {{ request()->routeIs('users.technical') ? 'active' : '' }}" href="{{ Route::has('users.technical') ? route('users.technical') : url('users.technical') }}"><i class="mdi mdi-adjust"></i><span class="hide-menu"> 2. Technical Assistance</span></a></li>
                                       <li class="sidebar-item"><a  class="sidebar-link {{ request()->routeIs('users.nextpage') ? 'active' : '' }}" href="{{ Route::has('users.nextpage') ? route('users.nextpage') : url('users/nextpage') }}"><i class="mdi mdi-adjust"></i><span class="hide-menu"> 3 Nextpage</span></a></li> 
                                <li class="sidebar-item"><a  class="sidebar-link {{ request()->routeIs('sub_category.index') ? 'active' : '' }}" href="{{ Route::has('sub_category.index') ? route('sub_category.index') : url('sub_category') }}"><i class="mdi mdi-adjust"></i><span class="hide-menu"> 3 Sub Category</span></a></li> 
